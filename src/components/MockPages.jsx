...
export function Step2SetupEvent() {
  return (
    <div className="bg-white border border-[#d1d5db] shadow-sm text-sm p-6 min-h-[400px]">
      <h2 className="text-lg font-bold text-[#111827] mb-4 border-b pb-2">建立群眾預測活動 (Step 2)</h2>
...
export function Step3Dashboard() {
  return (
    <div className="bg-white border border-[#d1d5db] shadow-sm text-sm p-6 min-h-[400px]">
      <h2 className="text-lg font-bold text-[#111827] mb-4 border-b pb-2">商品企劃最終決定開發計劃 (Step 3)</h2>
      <div className="text-[#4b5563] mb-6">
...
export function Step4Designer() {
  return (
    <div className="bg-white border border-[#d1d5db] shadow-sm text-sm p-6 min-h-[400px]">
      <h2 className="text-lg font-bold text-[#111827] mb-4 border-b pb-2">設計師團隊設計服裝 (Step 4)</h2>
      <div className="text-[#4b5563] mb-6">
...
export function Step5QA() {
  return (
    <div className="bg-white border border-[#d1d5db] shadow-sm text-sm p-6 min-h-[400px]">
      <h2 className="text-lg font-bold text-[#111827] mb-4 border-b pb-2">優化系統 (Step 5)</h2>
      <div className="text-[#4b5563] mb-6">
